...
namespace hue
{
    ...
    const std::map<std::string, int> CODES = {
        {TEXT("black"),            0}, {TEXT("k"),   0},
        {TEXT("blue"),             1}, {TEXT("b"),   1},
        {TEXT("green"),            2}, {TEXT("g"),   2},
        {TEXT("aqua"),             3}, {TEXT("a"),   3},
        {TEXT("red"),              4}, {TEXT("r"),   4},
        {TEXT("purple"),           5}, {TEXT("p"),   5},
        {TEXT("yellow"),           6}, {TEXT("y"),   6},
        {TEXT("white"),            7}, {TEXT("w"),   7},
        {TEXT("grey"),             8}, {TEXT("e"),   8},
        {TEXT("light blue"),       9}, {TEXT("lb"),  9},
        {TEXT("light green"),     10}, {TEXT("lg"), 10},
        {TEXT("light aqua"),      11}, {TEXT("la"), 11},
        {TEXT("light red"),       12}, {TEXT("lr"), 12},
        {TEXT("light purple"),    13}, {TEXT("lp"), 13},
        {TEXT("light yellow"),    14}, {TEXT("ly"), 14},
        {TEXT("bright white"),    15}, {TEXT("bw"), 15}
    };
    ...
    const std::map<int, std::string> NAMES = {
        ...
        {11, TEXT("light aqua")},
        {12, TEXT("light red")},
        {13, TEXT("light purple")},
        {14, TEXT("light yellow")},
        {15, TEXT("bright white")}
    };
    ...
    {
        return (0 <= c && c < 256) ?
            TEXT("(text) ") + NAMES.at(c % 16) + TEXT(" + ") +
            TEXT("(background) ") + NAMES.at(c / 16) :
            TEXT("BAD COLOR");
    }
