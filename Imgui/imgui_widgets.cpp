...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power)
{
    ...
    // Render grab
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x + 1, frame_bb.Min.y + 3.25), ImVec2(grab_bb.Max.x - 3, grab_bb.Max.y), ImColor(113, 88, 224, 255), style.GrabRounding);
    window->DrawList->AddRectFilledMultiColor(ImVec2(frame_bb.Min.x + 1, frame_bb.Min.y + 3.25), ImVec2(grab_bb.Max.x - 3, grab_bb.Max.y), ImColor(113, 88, 224, 255), ImColor(113, 88, 224, 255), ImColor(113, 88, 224, 255), ImColor(113, 88, 224, 255));
    ...
    // window->DrawList->AddText(ImVec2(frame_bb.Min.x + 3, frame_bb.Min.y + 2), GetColorU32({ 0.4f, 0.4f, 0.4f, 0.8f }), value_buf);
     ...
     //actual text
    window->DrawList->AddText(ImVec2(frame_bb.Min.x + 3, frame_bb.Min.y + 3), GetColorU32(ImGuiCol_Text), value_buf);
